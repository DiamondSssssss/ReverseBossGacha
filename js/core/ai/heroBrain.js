import { getHeroProfile } from './profiles.js?v=136';
import { scoreMonsterForHero, dist } from './targeting.js?v=136';
import {
...
import { findPath, findPathAway, buildBlockedFromMap } from '../pathfinding.js?v=136';
