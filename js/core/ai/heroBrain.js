import { getHeroProfile } from './profiles.js?v=86';
import { scoreMonsterForHero, dist } from './targeting.js?v=86';
import {
...
import { findPath, findPathAway, buildBlockedFromMap } from '../pathfinding.js?v=86';
