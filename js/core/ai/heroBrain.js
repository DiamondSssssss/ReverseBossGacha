import { getHeroProfile } from './profiles.js?v=92';
import { scoreMonsterForHero, dist } from './targeting.js?v=92';
import {
...
import { findPath, findPathAway, buildBlockedFromMap } from '../pathfinding.js?v=92';
