import { getHeroProfile } from './profiles.js?v=90';
import { scoreMonsterForHero, dist } from './targeting.js?v=90';
import {
...
import { findPath, findPathAway, buildBlockedFromMap } from '../pathfinding.js?v=90';
