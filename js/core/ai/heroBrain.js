import { getHeroProfile } from './profiles.js?v=96';
import { scoreMonsterForHero, dist } from './targeting.js?v=96';
import {
...
import { findPath, findPathAway, buildBlockedFromMap } from '../pathfinding.js?v=96';
