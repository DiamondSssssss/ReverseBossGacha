import { COMBAT, SPELLS, HERO_CLASS_LABELS } from '../data/constants.js?v=59';
import { MONSTER_BY_ID } from '../data/monsters.js?v=59';
import { terrainAt, isPlaceable } from '../data/maps.js?v=59';
import { bossSpells, DEFAULT_BOSS_ID, getBoss } from '../data/dungeonBosses.js?v=59';
import { mapUsedCost } from './dungeon.js?v=59';
import { buildBlockedFromMap, cellCenterWorld } from './pathfinding.js?v=59';
import { ParticleSystem } from '../render/particles.js?v=59';
import {
  getMonsterSprite,
  getHeroSprite,
  drawSpriteAt,
} from '../render/sprites.js?v=59';
import { tickHeroBrain, heroSpeedMultiplier, rebuildHeroPath, rebuildKitePath } from './ai/heroBrain.js?v=59';
import { tickMonsterBrain, inferMonsterAi } from './ai/monsterBrain.js?v=59';
import { computeHeroAttackDamage, applyIncomingDamage } from './ai/skills.js?v=59';
import { getTileModifiers, spawnMonsterStats } from './ai/tileModifiers.js?v=59';
import { dist } from './ai/targeting.js?v=59';
import { getHeroProfile } from './ai/profiles.js?v=59';
import {
  patternForHero,
  patternForMonster,
  beginAttack,
  ...
  ensureAttackState,
  resolveDisplayAnim,
} from './ai/attackPatterns.js?v=59';
