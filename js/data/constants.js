...
export const SPELLS = {
  ...
  crimson_thaw: {
    id: 'crimson_thaw',
    name: 'Tan Huyết',
    desc: 'Hồi 18% HP, xóa đốt/độc/chậm trên toàn bộ quái',
    cooldown: 24,
    kind: 'cleanse_heal',
    healRatio: 0.18,
  },
  ...
  inferno_banner: {
    id: 'inferno_banner',
    name: 'Cờ Dung Nham',
    desc: 'Dựng vùng dung nham 4.2s tại cụm Hero dẫn đầu, đốt 11 DPS',
    cooldown: 25,
    kind: 'ember_field',
    duration: 4.2,
    radius: 2.1,
  ...
  blast_furnace: {
    id: 'blast_furnace',
    name: 'Lò Xung Kích',
    desc: 'Sóng nhiệt đẩy mọi Hero lùi 2 ô và đốt 10 DPS trong 3.2s',
    cooldown: 16,
    kind: 'knock_burn',
    cells: 2,
    dps: 10,
  ...
  grave_bloom: {
    id: 'grave_bloom',
    name: 'Nở Mộ',
    desc: 'Rút 13% HP tối đa từ 3 Hero gần kho nhất rồi hồi 9% HP cho toàn quái',
    cooldown: 20,
    kind: 'drain_pulse',
    heroCount: 3,
    damageRatio: 0.13,
  ...
  rot_tide: {
    id: 'rot_tide',
    name: 'Triều Thối',
    desc: 'Mưa axit lên cụm Hero dẫn đầu: 10% HP tối đa ngay lập tức + độc 12 DPS trong 4s',
    cooldown: 20,
    kind: 'acid_rain',
    radius: 2,
    damageRatio: 0.1,
  ...
  seer_pupil: {
    id: 'seer_pupil',
    name: 'Đồng Tử Soi',
    desc: 'Silence 2 Hero ở xa kho nhất 3.5s và làm chậm 45%',
    cooldown: 15,
  ...
  stone_feast: {
    id: 'stone_feast',
    name: 'Yến Đá',
    desc: 'Nện khu vực kho báu: Hero gần kho nhận 12% HP tối đa + 16 damage, quái hồi 6%',
    cooldown: 20,
  ...
  doom_march: {
    ...
    desc: 'Quái +18% ATK, +14% tốc đánh và +10% tốc chạy trong 6s',
    cooldown: 22,
    kind: 'doom_march',
    duration: 6,
    atkMul: 1.18,
