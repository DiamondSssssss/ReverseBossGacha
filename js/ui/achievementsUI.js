import { ACHIEVEMENTS, CATEGORY_LABELS } from '../data/achievements.js';
import { achievementProgress, isGameCleared } from '../core/achievements.js';
...
export function renderAchievements(root, ctx) {
  ...
  root.innerHTML = `
    <div class="ach-hero">
      ...
      <p class="muted">Phá đảo khi thắng ải 20. Thưởng cộng ngay khi mở khóa.</p>
    </div>
    <div class="ach-summary">
      <div class="row spread">
        ...
        <div class="${cleared ? 'cleared-badge' : 'muted'}">${cleared ? 'Phá đảo' : 'Mốc: ải 20'}</div>
      </div>
