import { SPELLS, REWARDS, RARITY_COLORS, MAX_STAGE } from '../data/constants.js?v=113';
import { MONSTER_BY_ID } from '../data/monsters.js?v=113';
import { bossSpells, getBoss, syncUnlockedBosses } from '../data/dungeonBosses.js?v=113';
import { CombatEngine } from '../core/combatEngine.js?v=113';
import { saveState } from '../core/storage.js?v=113';
import { evaluateAchievements, isGameCleared } from '../core/achievements.js?v=113';
import {
  evaluateChallengeResult,
  grantChallengeReward,
  titleName,
} from '../core/challenge.js?v=113';
import { loadoutPoolCost } from '../core/loadout.js?v=113';
import {
  frontierForMode,
  recordPersonalBestCost,
} from '../data/hardMode.js?v=113';
import { submitStageBestCost } from '../core/stageRecords.js?v=113';
import { isLoggedIn } from '../core/auth.js?v=113';
import { monsterSpriteUrl } from '../render/sprites.js?v=113';
import { bindMonsterTips, hideMonsterTip } from './monsterTip.js?v=113';
