...
import { totalPlacements } from '../core/dungeon.js';
import { loadoutUnitCount } from '../core/loadout.js';
...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    body: '<ul class="tut-list"><li><strong>Linh Hồn</strong> — thắng/thua → Gacha</li><li><strong>Vàng</strong> — nâng quái trong Kho</li><li><strong>Gem</strong> — nâng Cap hầm ở Sảnh</li></ul>Xong hướng dẫn — giữ kho &amp; phá đảo ải 20!',
